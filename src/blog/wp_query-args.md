---
title: "Функция WP_Query — список аргументов"
description: "Функция WP_Query один из наиболее часто используемых классов в работе WordPress-разработчика. Данный пост является заметкой сниппетом, в нем перечислены все аргументы которые могут передаваться в качестве параметра для выборки постов WordPress."
date: "2018-08-26"
---
